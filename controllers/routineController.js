...
//       title: `📅 Class Routine: ${new Date(date).toLocaleDateString(
//         "en-IN",
//         {
//           weekday: "long",
//           day: "numeric",
...
//       message: `${slotCount} class${
//         slotCount > 1 ? "es" : ""
//       } scheduled. Click to view and download.`,

//       link: `/student/notifications?section=routine&date=${date}&branch=${branch}`,
